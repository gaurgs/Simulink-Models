#ifndef __c2_ZFBD_h__
#define __c2_ZFBD_h__
...
#ifndef typedef_SFc2_ZFBDInstanceStruct
#define typedef_SFc2_ZFBDInstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_ZFBD;
} SFc2_ZFBDInstanceStruct;

#endif                                 /*typedef_SFc2_ZFBDInstanceStruct*/
...
extern void c2_ZFBD_method_dispatcher(SimStruct *S, int_T method, void *data);

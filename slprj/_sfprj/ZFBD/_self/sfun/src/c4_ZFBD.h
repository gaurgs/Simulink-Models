#ifndef __c4_ZFBD_h__
#define __c4_ZFBD_h__
...
#ifndef typedef_SFc4_ZFBDInstanceStruct
#define typedef_SFc4_ZFBDInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_ZFBD;
} SFc4_ZFBDInstanceStruct;

#endif                                 /*typedef_SFc4_ZFBDInstanceStruct*/
...
extern void c4_ZFBD_method_dispatcher(SimStruct *S, int_T method, void *data);

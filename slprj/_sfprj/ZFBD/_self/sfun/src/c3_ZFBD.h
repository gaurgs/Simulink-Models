#ifndef __c3_ZFBD_h__
#define __c3_ZFBD_h__
...
#ifndef typedef_SFc3_ZFBDInstanceStruct
#define typedef_SFc3_ZFBDInstanceStruct
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_ZFBD;
} SFc3_ZFBDInstanceStruct;

#endif                                 /*typedef_SFc3_ZFBDInstanceStruct*/
...
extern void c3_ZFBD_method_dispatcher(SimStruct *S, int_T method, void *data);

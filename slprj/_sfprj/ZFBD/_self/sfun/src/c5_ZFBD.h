#ifndef __c5_ZFBD_h__
#define __c5_ZFBD_h__
...
#ifndef typedef_SFc5_ZFBDInstanceStruct
#define typedef_SFc5_ZFBDInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_ZFBD;
} SFc5_ZFBDInstanceStruct;

#endif                                 /*typedef_SFc5_ZFBDInstanceStruct*/
...
extern void c5_ZFBD_method_dispatcher(SimStruct *S, int_T method, void *data);

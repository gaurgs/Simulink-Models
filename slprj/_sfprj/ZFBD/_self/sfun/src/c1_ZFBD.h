#ifndef __c1_ZFBD_h__
#define __c1_ZFBD_h__
...
#ifndef typedef_SFc1_ZFBDInstanceStruct
#define typedef_SFc1_ZFBDInstanceStruct
...
typedef struct {
  ...
  uint8_T c1_is_active_c1_ZFBD;
} SFc1_ZFBDInstanceStruct;

#endif                                 /*typedef_SFc1_ZFBDInstanceStruct*/
...
extern void c1_ZFBD_method_dispatcher(SimStruct *S, int_T method, void *data);

...
static void initialize_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance);
static void initialize_params_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance);
static void enable_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct *chartInstance);
static void disable_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_SDR_Lowpass
  (SFc2_SDR_LowpassInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SDR_Lowpass
  (SFc2_SDR_LowpassInstanceStruct *chartInstance);
static void set_sim_state_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance);
static void sf_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct *chartInstance);
static void c2_chartstep_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance);
static void initSimStructsc2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance);
static void registerMessagesc2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_SDR_LowpassInstanceStruct *chartInstance,
  const mxArray *c2_N, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_SDR_LowpassInstanceStruct
...
static void c2_eml_scalar_eg(SFc2_SDR_LowpassInstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_SDR_LowpassInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_SDR_LowpassInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_SDR_Lowpass, const char_T
  *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_SDR_LowpassInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_SDR_LowpassInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SDR_Lowpass = 0U;
}
  ...
  (SFc2_SDR_LowpassInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal = chartInstance->c2_is_active_c2_SDR_Lowpass;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "y");
  chartInstance->c2_is_active_c2_SDR_Lowpass = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_SDR_Lowpass");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SDR_Lowpass(chartInstance);
...
static void sf_c2_SDR_Lowpass(SFc2_SDR_LowpassInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SDR_Lowpass(chartInstance);
  ...
  *chartInstance)
{
  ...
  c2_b_rx_signal = (creal_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  for (c2_k = 0; c2_k < 10; c2_k++) {
    ...
    c2_b_x = c2_x[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c2_b_k), 1, 10, 1, 0) - 1];
    c2_x1 = c2_b_x.re;
    c2_x2 = c2_b_x.im;
    c2_a = c2_x1;
    c2_b = c2_x2;
    ...
    c2_c_y[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c2_b_k), 1, 10, 1, 0) - 1] = c2_b_y;
  }

  for (c2_c_k = 0; c2_c_k < 10; c2_c_k++) {
    c2_d_k = 1.0 + (real_T)c2_c_k;
    c2_ak = c2_c_y[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c2_d_k), 1, 10, 1, 0) - 1];
    c2_b_a = c2_ak;
    ...
    c2_e_y[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c2_d_k), 1, 10, 1, 0) - 1] = c2_d_y;
  }
  ...
  for (c2_e_k = 2; c2_e_k < 11; c2_e_k++) {
    ...
    c2_energy += c2_e_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c2_f_k), 1, 10, 1, 0) - 1];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SDR_LowpassInstanceStruct *chartInstance;
  chartInstance = (SFc2_SDR_LowpassInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  for (c2_i2 = 0; c2_i2 < 10; c2_i2++) {
    c2_b_inData[c2_i2] = (*(creal_T (*)[10])c2_inData)[c2_i2];
  }
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 1U, 1U, 0U, 2, 10, 1), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}

const mxArray *sf_c2_SDR_Lowpass_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SDR_Lowpass), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SDR_Lowpass);
  return c2_y;
}
...
void sf_c2_SDR_Lowpass_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3390487094U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4250071545U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3389762453U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(739729278U);
}

mxArray *sf_c2_SDR_Lowpass_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yAgbUiEaioLfUpSt4SVPFD");
...
mxArray *sf_c2_SDR_Lowpass_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_SDR_Lowpass(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[9],T\"N\",},{M[1],M[8],T\"nvar\",},{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_SDR_Lowpass\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SDR_Lowpass_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_SDR_LowpassInstanceStruct *chartInstance;
    chartInstance = (SFc2_SDR_LowpassInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c2_snrdB = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c2_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_rx_signal = (creal_T (*)[10])ssGetInputPortSignal(chartInstance->S,
            0);
...
{
  return "JpNuTXX5j5SETDYPPPDd0C";
}

static void sf_opaque_initialize_c2_SDR_Lowpass(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*)
    chartInstanceVar);
  initialize_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_SDR_Lowpass(void *chartInstanceVar)
{
  enable_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SDR_Lowpass(void *chartInstanceVar)
{
  disable_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_SDR_Lowpass(void *chartInstanceVar)
{
  sf_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SDR_Lowpass(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SDR_Lowpass
    ((SFc2_SDR_LowpassInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SDR_Lowpass();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SDR_Lowpass(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SDR_Lowpass(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SDR_Lowpass(S);
}

static void sf_opaque_set_sim_state_c2_SDR_Lowpass(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_SDR_Lowpass(S, st);
}

static void sf_opaque_terminate_c2_SDR_Lowpass(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SDR_Lowpass_optimization_info();
    }

    finalize_c2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_SDR_Lowpass((SFc2_SDR_LowpassInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SDR_Lowpass(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_SDR_Lowpass(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4051109833U));
  ssSetChecksum1(S,(3653030776U));
  ssSetChecksum2(S,(4132929394U));
  ssSetChecksum3(S,(1131676657U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_SDR_Lowpass(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SDR_Lowpass(SimStruct *S)
{
  SFc2_SDR_LowpassInstanceStruct *chartInstance;
  chartInstance = (SFc2_SDR_LowpassInstanceStruct *)utMalloc(sizeof
    (SFc2_SDR_LowpassInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SDR_LowpassInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_SDR_Lowpass;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_SDR_Lowpass;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_SDR_Lowpass;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_SDR_Lowpass;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_SDR_Lowpass;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_SDR_Lowpass;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_SDR_Lowpass;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SDR_Lowpass;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SDR_Lowpass;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SDR_Lowpass;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_SDR_Lowpass;
...
void c2_SDR_Lowpass_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SDR_Lowpass(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SDR_Lowpass(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SDR_Lowpass(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SDR_Lowpass_method_dispatcher.\n"

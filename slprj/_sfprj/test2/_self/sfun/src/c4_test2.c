...
static void initialize_c4_test2(SFc4_test2InstanceStruct *chartInstance);
static void initialize_params_c4_test2(SFc4_test2InstanceStruct *chartInstance);
static void enable_c4_test2(SFc4_test2InstanceStruct *chartInstance);
static void disable_c4_test2(SFc4_test2InstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_test2(SFc4_test2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_test2(SFc4_test2InstanceStruct
  *chartInstance);
static void set_sim_state_c4_test2(SFc4_test2InstanceStruct *chartInstance,
  const mxArray *c4_st);
static void finalize_c4_test2(SFc4_test2InstanceStruct *chartInstance);
static void sf_c4_test2(SFc4_test2InstanceStruct *chartInstance);
static void initSimStructsc4_test2(SFc4_test2InstanceStruct *chartInstance);
static void registerMessagesc4_test2(SFc4_test2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_test2InstanceStruct *chartInstance, const
  mxArray *c4_N, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_test2InstanceStruct *chartInstance,
...
static void c4_eml_scalar_eg(SFc4_test2InstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_test2InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_test2InstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_test2, const char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_test2InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_test2InstanceStruct *chartInstance);
...
static void initialize_c4_test2(SFc4_test2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_test2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_c_hoistedGlobal = chartInstance->c4_is_active_c4_test2;
  ...
  const mxArray *c4_st)
{
  ...
  *c4_Power = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    1)), "Power");
  chartInstance->c4_is_active_c4_test2 = c4_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 2)), "is_active_c4_test2");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_test2(chartInstance);
...
static void sf_c4_test2(SFc4_test2InstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c4_b_Power, 1U);
  _SFD_DATA_RANGE_CHECK(*c4_b_N, 2U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  ...
  *c4_b_N = c4_N;
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_test2MachineNumber_,
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u;
  const mxArray *c4_y = NULL;
  SFc4_test2InstanceStruct *chartInstance;
  chartInstance = (SFc4_test2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_test2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c4_b_is_active_c4_test2, const char_T *c4_identifier)
{
  ...
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_is_active_c4_test2),
    &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_test2);
  return c4_y;
}
...
void sf_c4_test2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3884785646U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(706669904U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3099684145U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1317151646U);
}

mxArray *sf_c4_test2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xtKGVhNsbqf0g9zLzKKYLD");
...
mxArray *sf_c4_test2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c4_test2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[6],T\"N\",},{M[1],M[5],T\"Power\",},{M[8],M[0],T\"is_active_c4_test2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_test2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_test2InstanceStruct *chartInstance;
    chartInstance = (SFc4_test2InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_test2MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_test2MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _test2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "odjwCUJ5gTxPVxLU7QpqD";
}

static void sf_opaque_initialize_c4_test2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_test2InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
  initialize_c4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_test2(void *chartInstanceVar)
{
  enable_c4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_test2(void *chartInstanceVar)
{
  disable_c4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_test2(void *chartInstanceVar)
{
  sf_c4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_test2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_test2((SFc4_test2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_test2();/* state var info */
...
extern void sf_internal_set_sim_state_c4_test2(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_test2((SFc4_test2InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_test2(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_test2(S);
}

static void sf_opaque_set_sim_state_c4_test2(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_test2(S, st);
}

static void sf_opaque_terminate_c4_test2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_test2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_test2_optimization_info();
    }

    finalize_c4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_test2((SFc4_test2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_test2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_test2((SFc4_test2InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_test2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_test2_optimization_info();
  ...
  ssSetChecksum0(S,(2426216819U));
  ssSetChecksum1(S,(1239796034U));
  ssSetChecksum2(S,(1681432002U));
  ssSetChecksum3(S,(3675427653U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_test2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_test2(SimStruct *S)
{
  SFc4_test2InstanceStruct *chartInstance;
  chartInstance = (SFc4_test2InstanceStruct *)utMalloc(sizeof
    (SFc4_test2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_test2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_test2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_test2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_test2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_test2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_test2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_test2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_test2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_test2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_test2;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_test2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_test2;
...
void c4_test2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_test2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_test2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_test2_method_dispatcher.\n"

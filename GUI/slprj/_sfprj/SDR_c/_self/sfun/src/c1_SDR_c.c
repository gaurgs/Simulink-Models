...
static void initialize_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void initialize_params_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void enable_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void disable_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_SDR_c(SFc1_SDR_cInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_SDR_c(SFc1_SDR_cInstanceStruct
  *chartInstance);
static void set_sim_state_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void sf_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void initSimStructsc1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void registerMessagesc1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_eml_scalar_eg(SFc1_SDR_cInstanceStruct *chartInstance);
static void c1_eml_error(SFc1_SDR_cInstanceStruct *chartInstance);
static real_T c1_emlrt_marshallIn(SFc1_SDR_cInstanceStruct *chartInstance, const
  mxArray *c1_qfuncinv, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_SDR_cInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_SDR_cInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_SDR_cInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_SDR_c, const char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_SDR_cInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_SDR_cInstanceStruct *chartInstance);
...
static void initialize_c1_SDR_c(SFc1_SDR_cInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_SDR_c = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_SDR_c;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_SDR_c = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 0)), "is_active_c1_SDR_c");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_SDR_c(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u;
  const mxArray *c1_y = NULL;
  SFc1_SDR_cInstanceStruct *chartInstance;
  chartInstance = (SFc1_SDR_cInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_SDR_c_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_SDR_c, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_SDR_c),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_SDR_c);
  return c1_y;
}
...
void sf_c1_SDR_c_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_SDR_c_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_SDR_c_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_SDR_c(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c1_SDR_c\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_SDR_c_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_SDR_cInstanceStruct *chartInstance;
    chartInstance = (SFc1_SDR_cInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_SDR_c(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_SDR_cInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
  initialize_c1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_SDR_c(void *chartInstanceVar)
{
  enable_c1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_SDR_c(void *chartInstanceVar)
{
  disable_c1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_SDR_c(void *chartInstanceVar)
{
  sf_c1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_SDR_c(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_SDR_c((SFc1_SDR_cInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_SDR_c();/* state var info */
...
extern void sf_internal_set_sim_state_c1_SDR_c(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_SDR_c((SFc1_SDR_cInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_SDR_c(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_SDR_c(S);
}

static void sf_opaque_set_sim_state_c1_SDR_c(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_SDR_c(S, st);
}

static void sf_opaque_terminate_c1_SDR_c(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SDR_cInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SDR_c_optimization_info();
    }

    finalize_c1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_SDR_c((SFc1_SDR_cInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_SDR_c(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_SDR_c((SFc1_SDR_cInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_SDR_c(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_SDR_c(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SDR_c(SimStruct *S)
{
  SFc1_SDR_cInstanceStruct *chartInstance;
  chartInstance = (SFc1_SDR_cInstanceStruct *)utMalloc(sizeof
    (SFc1_SDR_cInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_SDR_cInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_SDR_c;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_SDR_c;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_SDR_c;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_SDR_c;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_SDR_c;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_SDR_c;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_SDR_c;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_SDR_c;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_SDR_c;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_SDR_c;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_SDR_c;
...
void c1_SDR_c_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SDR_c(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SDR_c(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SDR_c_method_dispatcher.\n"
